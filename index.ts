const attackButton = document.querySelector(".attackButton") as HTMLButtonElement
const hpBar = document.querySelectorAll(".hpBar") as NodeListOf<HTMLElement>
const hp = document.querySelectorAll(".hp") as NodeListOf<HTMLElement>
const gold = document.querySelector(".gold") as HTMLElement
const hpPotion = document.querySelector(".hpPotion") as HTMLElement
const monsterImg = document.querySelector(".monster") as HTMLImageElement
const playerWeapons = document.querySelectorAll(".weapons > img") as NodeListOf<HTMLElement>
...
attackButton.onclick = () => {
    ...
    // @ts-ignore
    const playerAttack: number = getRandomNumber(weaponSelected.maxDamage)
    const monsterAttack: number = getRandomNumber(10)
